...
import { setIsPollsTabFocused } from '../../../chat/actions.any';
...
class Toolbox extends Component<Props> {
    ...
    constructor(props: Props) {
        ...
        this._onToolbarTogglePoll = this._onToolbarTogglePoll.bind(this);
    ...
    _getAllButtons() {
        ...
        const togglePoll = {
            key: 'toggle-poll',
            Content: TogglePollButton,
            handleClick: this._onToolbarTogglePoll,
            group: 2
        };
