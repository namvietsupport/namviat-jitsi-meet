...
import { fullScreenChanged, showToolbox, setFullScreen, setOverflowMenuVisible } from '../../../toolbox/actions.web';
import { JitsiPortal, Toolbox } from '../../../toolbox/components/web';
import FullscreenButton from '../../../toolbox/components/web/FullscreenButton';
import { TileViewButton, LAYOUTS, getCurrentLayout } from '../../../video-layout';
    ...
    render() {
        ...
        return (
            <div
                ...
                <ParticipantsPane />
                { _innerWidth > 754 && (_showPrejoin || _showLobby || (<div
